...
const testFilterEndpoint = async () => {
  try {
    ...
    console.log('   URL: http://localhost:3001/api/payroll/filters');
    
    const response1 = await fetch('http://localhost:3001/api/payroll/filters', {
      method: 'GET',
      headers: {
    ...
    const response2 = await fetch('http://localhost:3001/api/payroll?pageSize=100000');
