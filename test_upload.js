...
async function testUploadEndpoints() {
  ...
  try {
    ...
    const healthResponse = await fetch('http://numericaapi.kretosstechnology.com:3001/health');
  ...
  try {
    ...
    const infoResponse = await fetch('http://numericaapi.kretosstechnology.com:3001/api/info');
  ...
  try {
    ...
    const validateResponse = await fetch('http://numericaapi.kretosstechnology.com:3001/api/validate-file', {
      method: 'POST',
      body: new FormData()
    });
  ...
  try {
    ...
    const uploadResponse = await fetch('http://numericaapi.kretosstechnology.com:3001/api/upload-data', {
      method: 'POST',
      body: new FormData()
    });
