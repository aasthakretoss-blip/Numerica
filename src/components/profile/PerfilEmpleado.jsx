...
const PerfilEmpleado = ({ rfc }) => {
  ...
  const handlePeriodChange = (period) => {
    ...
    console.log('🔍 [PerfilEmpleado] TIPO DE DATO RECIBIDO:', typeof period, 'Es array?', Array.isArray(period));
    console.log('🔍 [PerfilEmpleado] ANTES - selectedPeriod era:', selectedPeriod);
    
    setSelectedPeriod(period);
    
    console.log('🔍 [PerfilEmpleado] DESPUÉS - selectedPeriod ahora es:', period);
    console.log('🔥 [PerfilEmpleado] ENVIANDO ESTE VALOR A PayrollDataViewer:', period);
  ...
  return (
    <PerfilContainer>
      ...
      <ContentContainer>
        ...
        {/* TODO: Textboxes de información general conectados al backend */}
        
        {/* Datos de nómina del empleado */}
        {console.log('🚨 [PerfilEmpleado] RENDERIZANDO PayrollDataViewer con selectedPeriod:', selectedPeriod)}
        <PayrollDataViewer 
          curp={curpFromURL}
