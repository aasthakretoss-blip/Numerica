...
const PercepcionesAdicionalesSection = ({ data, loading }) => {
  ...
  const fields = [
    ...
    { key: 'sueldoDiasVacaciones', label: 'Sueldo x días AC vacaciones', dbField: ' SUELDO X DIAS AC VACACIONES ', isCurrency: true },
    ...
    { key: 'primaAntiguedad', label: 'Prima de antigüedad', dbField: ' PRIMA DE ANTIGUEDAD ', isCurrency: true },
