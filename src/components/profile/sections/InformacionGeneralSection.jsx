...
const InformacionGeneralSection = ({ data, loading, selectedPeriod }) => {
  ...
  const fields = [
    ...
    },
    {
      key: "compania",
      label: "Compañía",
      dbFields: ["Compañía", "Compania", "compania", "sucursal"],
    },
    {
      key: "cvetno",
      label: "Cvetno",
      dbFields: ["cvetno", "Cvetno"],
    },
    {
      key: "sucursal",
      label: "Sucursal",
      dbFields: ["sucursal", "Sucursal", "Compañía", "Compania", "department"],
    },
    {
      key: "localidad",
      label: "Localidad",
      dbFields: ["Localidad", "localidad"],
    },
    {
      key: "periodicidad",
      label: "Periodicidad",
      dbFields: ["Periodicidad", "periodicidad"],
    },
    {
      key: "claveTrabajador",
    ...
    },
    {
      ...
      dbFields: ["nombre", "Nombre completo", "name"],
      highlight: true,
    },
    {
      key: "puesto",
      label: "Puesto",
      dbFields: ["puesto", "Puesto", "position"],
    },
    { key: "rfc", label: "RFC", dbFields: ["rfc", "RFC"] },
    {
      key: "curp",
      label: "CURP",
      dbFields: ["curp", "CURP", "Curp"],
      highlight: true,
    },
    ...
    },
    {
      key: "status",
      label: "Status",
      dbFields: ["estado", "Estado", "Status", "status"],
    },
  ];
