...
const TotalesSection = ({ data, loading }) => {
  ...
  const fields = [
    { key: ' TOTAL DE PERCEPCIONES ', label: 'Total de Percepciones', highlight: true },
    { key: ' TOTAL DEDUCCIONES ', label: 'Total Deducciones', highlight: true },
    { key: ' NETO ANTES DE VALES ', label: 'Neto Antes de Vales' },
    { key: ' NETO A PAGAR ', label: 'Neto a Pagar', highlight: true },
    { key: ' SUBTOTAL COSTO DE NOMINA ', label: 'Subtotal Costo de Nómina' },
    { key: ' COSTO DE NOMINA ', label: 'Costo de Nómina', highlight: true },
    { key: ' REGALÍAS ', label: 'Regalías' },
    { key: ' IVA ', label: 'IVA' },
    { key: ' TOTAL A FACTURAR ', label: 'Total a Facturar', highlight: true }
  ];
