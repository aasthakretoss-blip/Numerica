...
const AportacionesPatronalesSection = ({ data, loading }) => {
  ...
  const fields = [
    { key: ' P.FPL ', label: 'P.FPL' },
    { key: ' AYUDA POR INCAPACIDAD ', label: 'Ayuda por Incapacidad' },
    { key: ' APORTACION COMPRA PRESTACIÓN ', label: 'Aportación Compra Prestación' },
    { key: ' AP COMP PRIMAS SEGURO ', label: 'Ap Comp Primas Seguro' },
    { key: ' IMSS PATRONAL ', label: 'IMSS Patronal' },
    { key: ' INFONAVIT ', label: 'Infonavit' },
    { key: ' IMPUESTO SOBRE NÓMINA ', label: 'Impuesto sobre Nómina' },
    { key: ' PRESTAMOS PERSONALES ', label: 'Préstamos Personales' }
  ];

  return (
    <SectionContainer>
      <SectionTitle>Aportaciones Patronales</SectionTitle>
      <FieldsGrid>
...
export default AportacionesPatronalesSection;
