...
export default function SalaryAgePopulationPyramid({ 
  ...
  const handleBarClick = (age, gender, salaryBand) => {
    ...
    const selection = createSelection.salaryAgeGenderBand(age, gender, salaryBand, {
    ...
    console.log('🎯 SalaryAgePopulationPyramid: Emitiendo selección:', selection);
                        ...
                        {SALARY_BANDS.slice().reverse().map(band => {
                          ...
                          return (
                            <SalaryBar
                              ...
                              onClick={() => handleBarClick(age, 'female', band)}
