...
interface DetailedStats {
  topCompanies: Array<{ company: string; count: number; percentage: string }>;
  topPeriods: Array<{ period: string; count: number; percentage: string }>;
  salaryRanges: Array<{ range: string; count: number; percentage: string }>;
  employeeStats: {
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="text-center bg-white/50 rounded-lg p-3">
              <div className="text-2xl font-bold text-blue-700">
                {stats.averageRecordsPerEmployee}
              </div>
            ...
            <div className="border-t border-blue-200 pt-4">
              ...
              <div className="space-y-2">
                {stats.statusDistribution.map((status, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between bg-white/60 rounded-lg px-4 py-2"
                  >
                ...
                {detailedStats.topCompanies.map((company, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium">
                        {company.count.toLocaleString("es-MX")}
                      </span>
              ...
              <div className="space-y-2">
                {detailedStats.topPeriods.map((period, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium">
                        {period.count.toLocaleString("es-MX")}
                      </span>
                      <span className="text-xs text-gray-500">
                        ({period.percentage}%)
                      </span>
              ...
              <div className="space-y-2">
                {detailedStats.salaryRanges.map((range, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium">
                        {range.count.toLocaleString("es-MX")}
                      </span>
                      <span className="text-xs text-gray-500">
                        ({range.percentage}%)
                      </span>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-lg font-bold text-green-600">
                  {detailedStats.employeeStats.totalActiveEmployees.toLocaleString(
                    "es-MX"
                  )}
                </div>
              ...
              <div>
                <div className="text-lg font-bold text-red-600">
                  {detailedStats.employeeStats.totalInactiveEmployees.toLocaleString(
                    "es-MX"
                  )}
                </div>
              ...
              <div>
                <div className="text-lg font-bold text-gray-600">
                  {detailedStats.employeeStats.totalUnknownStatus.toLocaleString(
                    "es-MX"
                  )}
                </div>
