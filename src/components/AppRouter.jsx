  ...
  return (
    <LayoutWithSidebar user={user} userPermissions={userPermissions}>
      <Routes>
        <Route
          path="/"
          element={<Dashboard userPermissions={userPermissions} user={user} />}
        />
        <Route
          path="/dashboard"
          element={<Dashboard userPermissions={userPermissions} user={user} />}
        ...
        <Route
          path="/home"
          element={<Home userPermissions={userPermissions} user={user} />}
        />
        <Route path="/profile" element={<UserProfile />} />
        {/* Rutas del perfil de empleado */}
        <Route path="/perfil/:rfc/:curp" element={<EmployeeProfile />} />
        <Route path="/perfil/:rfc/:curp/fpl" element={<EmployeeProfile />} />
        <Route
          path="/perfil/:rfc/:curp/historico"
          element={<EmployeeProfile />}
        />
        <Route
          path="/perfil/:rfc/:curp/documentos"
          element={<EmployeeProfile />}
        />
      </Routes>
    </LayoutWithSidebar>
