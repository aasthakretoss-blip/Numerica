...
const AportacionesPatronalesSection = ({ data, loading }) => {
  ...
  const fields = [
    { key: 'PFPL', label: 'P.FPL' },
    { key: 'ayudaIncapacidad', label: 'Ayuda por Incapacidad' },
    { key: 'aportacionCompraPrestacion', label: 'Aportación Compra Prestación' },
    { key: 'apCompPrimasSeguro', label: 'Ap Comp Primas Seguro' },
    { key: 'imssPatronal', label: 'IMSS Patronal' },
    { key: 'infonavit', label: 'Infonavit' },
    { key: 'impuestoNomina', label: 'Impuesto sobre Nómina' },
    { key: 'ayudaFPL', label: 'Ayuda FPL' }
  ];
