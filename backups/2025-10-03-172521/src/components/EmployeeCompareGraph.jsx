...
const EmployeeCompareGraph = ({ 
  ...
  const processedData = useMemo(() => {
    ...
    employees.forEach((employee, index) => {
      ...
      if (groupedByEmployeeMonth.has(key)) {
        ...
        existing.total += (parseFloat(employee.totalCost) || 0);
        ...
        const newRecord = {
          ...
          total: parseFloat(employee.totalCost) || 0,
          recordCount: 1,
    ...
    if (['totalPercepciones', 'comisiones', 'salario'].includes(localSortBy)) {
  ...
  const chartData = useMemo(() => {
    ...
    // Línea de Total de Percepciones (Azul)
    ...
    <GraphContainer $collapsed={isCollapsed}>
      ...
      {statistics && !isCollapsed && (
        <StatsPanel>
          ...
          <StatItem>
            <div className="label">Total Promedio</div>
