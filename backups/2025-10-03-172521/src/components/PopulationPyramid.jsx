...
export default function PopulationPyramid({ 
  ...
  onSelectionChange     // Callback para cuando se hace clic en una barra
}) {
  ...
  const handleBarClick = (age, gender) => {
    if (onSelectionChange) {
      const selection = {
        type: 'pyramid_age_gender',
        data: {
          ageRange: [age, age], // Rango de 1 año específico
      ...
      console.log('🎯 PopulationPyramid: Enviando selección:', selection);
      onSelectionChange(selection);
    } else {
      console.warn('🎯 PopulationPyramid: onSelectionChange no definido');
    }
  };
